  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'l1-fingers', title: 'Sore fingertips? Totally normal', min: 3,
        objective: 'Understand why it hurts and build calluses without quitting — this is where most people give up, so read it.',
        steps: [
          'Sore fingertips are the #1 thing EVERY beginner feels. It is temporary — calluses form in about 2–4 weeks of regular playing.',
      ...
      { id: 'l1-5', title: 'SONG: Shady Grove (Em + G)', min: 8, songId: 'shady-grove',
        objective: 'Play a whole song with just the two chords you already know.',
