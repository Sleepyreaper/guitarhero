...
export const CURRICULUM = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'l2-shady', title: 'SONG: Shady Grove (Em + D + G)', min: 10, songId: 'shady-grove',
        objective: 'Play the Hindman E-minor version without mixing in the words or chords of another traditional variant.',
        goal: 'Follow one lyric-timed chorus without stopping, then play it once without the backing.',
        steps: [
          'Count “ONE two”: bass on ONE, short chord on two. Em is home; D answers the first phrase, while G lifts the third phrase before D returns home.',
          'Choose Practice accompaniment and follow the lyric cue through one chorus.',
          'Use only this chart’s “I know / Bound for Shady Grove” chorus while you learn it; other recordings may use legitimate but incompatible verses.',
          'Then pause the app and keep the same dry, steady two-beat pulse yourself.',
        ] },
      ...
      { id: 'l2-4', title: 'SONG: He’s Got the Whole World', min: 10, songId: 'whole-world',
        objective: 'Back a joyful church song with only G and D while the vocal enters before beat 1.',
