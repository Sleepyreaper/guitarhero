...
export const CURRICULUM = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'l1-5', title: 'SONG: Row, Row, Row Your Boat (G)', min: 8, songId: 'row-your-boat',
        objective: 'Play a complete real song with the G chord you already know.',
        goal: 'Keep four steady down-strums per bar while you or someone else sings the whole song.',
        steps: [
          'Hold G and keep four relaxed down-strums per bar—the chord never changes.',
          'Have someone sing while you protect the beat. If a strum misses, keep your hand moving.',
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 'l2-3', title: 'SONG: Down in the Valley', min: 10, songId: 'down-in-the-valley', chords: ['D7'],
        ...
        steps: [
          'Learn D7 first: xx0212, a small triangle on the top four strings. Pick through it once so every note rings.',
